...
(async () => {
   try {
      ...
      app.post('/api/ignoreMessages', postHandler<IgnoreMessagesRequest, void>(
         messageController.ignoreMessages
      ));
