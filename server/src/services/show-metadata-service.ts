...
import { MovieDbCandidate, ShowBookmark, TypeSpecificMetadata } from '../models';
...
export class ShowMetadataService {
   ...
   // public async getShowDbCandidates(searchTerm: string): Promise<TypeSpecificMetadata<ShowBookmark, 'show'>[]> {
